...
import { QueryExpressionDirective } from './query-builder/query-expression.directive';
import { QueryComponentDirective } from './query-builder/query-component.directive';
...
@NgModule({
  ...
  declarations: [
    ...
    QueryInputDirective,
    QueryExpressionDirective,
    QueryComponentDirective,
