...
import { QueryExpressionDirective } from './query-expression.directive';
import { QueryComponentDirective } from './query-component.directive';
...
export class QueryBuilderComponent implements OnInit, OnChanges, ControlValueAccessor, Validator {
  ...
  @Input() parentExpressionTemplates: QueryList<QueryExpressionDirective>;
  @Input() parentComponentTemplates: QueryList<QueryComponentDirective>;
  ...
  @ContentChildren(QueryExpressionDirective) expressionTemplates: QueryList<QueryExpressionDirective>;
  @ContentChildren(QueryComponentDirective) componentTemplates: QueryList<QueryComponentDirective>;
